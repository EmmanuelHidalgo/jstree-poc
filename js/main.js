                ...
                [
                    {
                        ...
                        "children": [
                            {
                                "internalName": 'testSub1',
                                "children":[
                                    {"internalName": "testSub3"},
                                    {
                                        "internalName": "testSub4",
                                        "children": [
                                            {"internalName": "testSub5"}
                                        ]
                                    },
                                ]},
                                {"internalName": "testSub2"}],
                        "size": 0,
                        "sizeUnit": null,
                    ...
                    },
                    {
                        ...
                        "children": [
                            {
                                "internalName": "articleSub1",
                                "children": [
                                    {
                                        "internalName":"articleSub2"
                                    }
                                ]
                            }
                        ],
...
function parseData(mockData) {
    ...
    mockData.item.children.forEach((child) => {
        const nodes = child.children ? child.children : [];
        obj.core.data.push({
            'text': child.internalName,
...
$(function () {
    ...
    $('#jstree').jstree(parseData(mockData));
